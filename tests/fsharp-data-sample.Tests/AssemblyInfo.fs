...
[<assembly: AssemblyTitleAttribute("fsharp-data-sample.Tests")>]
[<assembly: AssemblyProductAttribute("fsharp-data-sample")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "fsharp-data-sample.Tests"
    let [<Literal>] AssemblyProduct = "fsharp-data-sample"
